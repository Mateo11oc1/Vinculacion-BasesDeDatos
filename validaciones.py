...
class Validaciones:
    ...
    def validarColVacia(self, columna: dict) -> tuple(dict, bool):
    ...
    def validarCaracteres(self, columna: dict) -> tuple(dict, bool):
    ...
    def validarSumaTamanio(self, columna: dict) -> tuple(dict, bool):
    ...
    def modificarCampoNAtractores(self, columna: dict) -> tuple(dict, bool):
    ...
    def validarJornadaDatosVacios(self, columna: dict) -> tuple(dict, bool):
    ...
    def validarSumaJornada(self, columna:dict) -> tuple(dict, bool):
    ...
    def validarJornadaNoSobrepaseAtractores(self, columna:dict) -> tuple(dict, bool):
        for i in columna['jornada']:
    ...
    def corregirDiurno(self, columna: dict) -> tuple(dict, bool):
    ...
    def validarDiasDatosVacios(self, columna: dict) -> tuple(dict, bool):
    ...
    def validarDiasNoSobrepaseAtractores(self, columna:dict) -> tuple(dict, bool):
        for i in columna['dias']:
            if columna["numAtractores"] < i:
    ...
    def validarSumaDias(self, columna:dict) -> tuple(dict, bool):
        ...
        if vacia[1]:
            ...
            if caracteres[1]:
                ...
                if jornada[1]:
                    ...
                    col2 = self.validarJornadaNoSobrepaseAtractores(col1[0])
                    self.corregirDiurno(col2[0])
                    
                dias = self.validarDiasDatosVacios(col2[0])
                if dias[1]:
                    pass
                else:
                    colDias = self.validarDiasNoSobrepaseAtractores(dias[0])
                    colRetorno = self.validarSumaDias(colDias[0])
